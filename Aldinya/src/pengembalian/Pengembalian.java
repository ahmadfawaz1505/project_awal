...
public class Pengembalian extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabelPeminjaman.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Item", "Nama Item", "Nama", "No. KTP", "No. HP", "Alamat", "Tgl Peminjaman", "Tgl Pengembalian", "Jumlah", "Harga Satuan", "Total Harga", "Tanggal Kembali"
            }
        ) {
        ...
        buttonTambah.setText("Tambah Pengembalian");
        ...
        tombolCetak.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        tombolCetak.setText("Cetak Struk");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(tanggalKembali, javax.swing.GroupLayout.DEFAULT_SIZE, 137, Short.MAX_VALUE))
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGap(79, 79, 79)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                .addGap(54, 54, 54)
                                .addComponent(tombolCetak, javax.swing.GroupLayout.PREFERRED_SIZE, 174, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(tombolCetak, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void buttonHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonHapusActionPerformed
        if (jumlahForm.getText().isEmpty()) {
            ...
            try {
                String sql = "delete from pengembalian where ktp='" + ktpForm.getText() + "'";
    ...
    private void tabelPeminjamanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelPeminjamanMouseClicked
        ...
        String tKembali = tabelPeminjaman.getValueAt(baris, 11).toString();
        tanggalKembali.setText(tKembali);
    ...
    private void tombolEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tombolEditActionPerformed
        if (idItemForm.getText().isEmpty() || namaItemForm.getText().isEmpty() || namaForm.getText().isEmpty() || ktpForm.getText().isEmpty() || hpForm.getText().isEmpty() || alamatForm.getText().isEmpty() || peminjamanForm.getText().isEmpty() || pengembalianForm.getText().isEmpty() || jumlahForm.getText().isEmpty()) {
            ...
            try {
                String sql = "UPDATE pengembalian SET id_item = '" + idItemForm.getText() + "', nama_item = '" + namaItemForm.getText() + "', nama = '" + namaForm.getText() + "', ktp= '" + ktpForm.getText() + "', hp= '" + hpForm.getText() + "', alamat= '" + alamatForm.getText() + "', tgl_pinjam= '" + peminjamanForm.getText() + "', tgl_kembali= '" + pengembalianForm.getText() + "', jumlah= '" + jumlahForm.getText() + "', tot_harga= '" + totalForm.getText() + "', tgl_pengembalian= '" + tanggalKembali.getText() + "' WHERE ktp='" + ktpForm.getText() + "'";
                java.sql.Connection conn = (Connection) koneksi.configDB();
                java.sql.PreparedStatement pst = conn.prepareStatement(sql);
                pst.execute();
